      ...
      >
        <div className="bg-bg-hover mx-20 lg:mr-0 lg:ml-20 rounded-xl p-6">
          ...
          <p className="text-left text-app-grey font-small md:w-[36rem] text-md lg:text-lg mt-2">
            At Carent, we&apos;ve developed a powerful SaaS platform
            specifically designed to empower small and medium-sized car rental
            businesses. Our user-friendly, all-in-one solution streamlines your
            daily operations, from online reservations and fleet management to
            ...
            you&apos;re just starting out or have an established fleet. Backed
            by robust security measures and reliable cloud-based infrastructure,
            you can trust your data to our platform. And with a dedicated
            support team on your side, you&apos;ll have the guidance and
            solutions you need to succeed in the competitive car rental
            industry.
          </p>
