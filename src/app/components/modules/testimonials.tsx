      ...
      <div data-aos="zoom-in">
        ...
        <div className="carousel w-full">
          ...
          <div id="testimonial2" className="carousel-item relative w-full">
            <div className="max-w-[80%] mx-auto text-center">
              <p className="max-w-[70%] mx-auto my-8 italic">
                "As a new player in the car rental market, we needed a flexible
                and scalable software solution to help us get off the ground
                quickly. Carent provided the perfect combination of an
          ...
          <div id="testimonial3" className="carousel-item relative w-full">
            <div className="max-w-[80%] mx-auto text-center">
              <p className="max-w-[70%] mx-auto my-8 italic">
                "Carent's all-in-one system has transformed the way we do
                business. We can now handle marketing, maintenance, payments,
          ...
          <div id="testimonial4" className="carousel-item relative w-full">
            <div className="max-w-[80%] mx-auto text-center">
              <p className="max-w-[70%] mx-auto my-8 italic">
                "Carent has streamlined our entire rental process, from online
                bookings to fleet management. The multi-channel booking system
                ensures we never miss an opportunity, while the intelligent CRM
                features help us provide a personalized experience for each
                customer. The ERP tool has consolidated all our data into one
                place, making it easier to manage billing, registrations, and
                more."
              </p>
              <p className="font-bold text-lg">
